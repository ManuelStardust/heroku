        ...
        <div className={"" + (this.props.data.className ? this.props.data.className : '') }>
          <Label data={ this.props.data } key={"label" + this.props.data.name } />
          {
            this.options.map((item,i)=>{
              ...
              return(
                <div className={"" + (this.props.data.className ? this.props.data.className : '') }>
                  <input className="form-check-input" key={this.props.data.name + "_" + i } type="radio" name={"" + this.props.data.name } id={"" + this.props.data.name } value={"" + item.value } onChange={ (this.props.onChange) ? this.props.onChange.bind(this) : null } defaultChecked={item.value == this.props.value} />
